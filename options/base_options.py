...
class BaseOptions():
    ...
    def initialize(self, parser):
        """定义在训练和测试中都使用的共同选项。"""
        # 基本参数
        parser.add_argument('--dataroot', default='placeholder', help='图像路径（应该有trainA、trainB、valA、valB等子文件夹）')
        parser.add_argument('--name', type=str, default='experiment_name', help='实验名称，决定了样本和模型存储的位置')
